...
const MajorProjectItem = ({ title, year, img  }) => {
  ...
  return (
    ...
    >
      <h1 ref={headingRef} className="mmedium font-bold ">
        {title}
      </h1>
      <h4 className="medium font-normal w-[30%]">{year}</h4>
      <div
        ref={imgDivRef}
        className="imgdiv pointer-events-none absolute h-[11rem] w-[11rem] opacity-0 -translate-x-1/2 -translate-y-1/2"
      >
        <img
          src={img}
